# Play Store listing — Humum Daiya (هموم داعية)
...
- **Package name**: `org.workshopdiy.humumdaiya`
...
```
كتاب "هموم داعية" تطبيق تفاعلي — للشيخ محمد الغزالي
```

### Full description (≤4000 chars)
```
📖 هموم داعية — تطبيق تفاعلي

تطبيق تفاعلي ثلاثي اللغة (عربي/إنجليزي/فرنسي) مستوحى من كتاب "هموم داعية" للشيخ محمد الغزالي رحمه الله (1917–1996).
...
• كتاب "هموم داعية" — الشيخ محمد الغزالي
...
### App name
```
Humum Daiya — Concerns of a Preacher
```

### Short description
```
"Concerns of a Preacher" — interactive trilingual app by Sheikh al-Ghazali
```
...
Interactive trilingual app (Arabic / English / French) based on the book "Concerns of a Preacher" by Sheikh Mohammed al-Ghazali (1917–1996).
...
• "Concerns of a Preacher" — Sheikh Mohammed al-Ghazali
...
### App name
```
Humum Daiya — Humum Daiya
```

### Short description
```
« Concerns of a Preacher » — application trilingue par Cheikh al-Ghazali
```
...
Application interactive trilingue (arabe / anglais / français) inspirée du livre « Concerns of a Preacher » du Cheikh Mohammed al-Ghazali (1917–1996).
...
• « Concerns of a Preacher » — Cheikh Mohammed al-Ghazali
...
```
Privacy Policy — Humum Daiya
Last updated: 2026-04-26

The Humum Daiya app does not collect, store, transmit, or share any personal
